<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FormMHS1.aspx.vb" Inherits="Pertemuan_P1_Latihan1_FormMHS" %>
...
<body>
    ...
    <center>Form Mahasiswa
        ...
        <asp:Label ID="outForm" runat="server" Text=""></asp:Label><br />
